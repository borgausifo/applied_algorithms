...
nondecreasing_1 = sorted(random_1)
nondecreasing_2 = sorted(random_2)
nondecreasing_3 = sorted(random_3)
nondecreasing_4 = sorted(random_4)
nondecreasing_5 = sorted(random_5)
nondecreasing_6 = sorted(random_6)
nondecreasing_7 = sorted(random_7)
nondecreasing_8 = sorted(random_8)
nondecreasing_9 = sorted(random_9)
nondecreasing_10 = sorted(random_10)
nondecreasing_11 = sorted(random_11)
nondecreasing_12 = sorted(random_12)
nondecreasing_13 = sorted(random_13)
nondecreasing_14 = sorted(random_14)
nondecreasing_15 = sorted(random_15)
nondecreasing_16 = sorted(random_16)
nondecreasing_17 = sorted(random_17)
nondecreasing_18 = sorted(random_18)
nondecreasing_19 = sorted(random_19)
nondecreasing_20 = sorted(random_20)

pickle_out = open('nd_random_integers_1.pickle', 'wb')
pickle.dump(nondecreasing_1, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_2.pickle', 'wb')
pickle.dump(nondecreasing_2, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_3.pickle', 'wb')
pickle.dump(nondecreasing_3, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_4.pickle', 'wb')
pickle.dump(nondecreasing_4, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_5.pickle', 'wb')
pickle.dump(nondecreasing_5, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_6.pickle', 'wb')
pickle.dump(nondecreasing_6, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_7.pickle', 'wb')
pickle.dump(nondecreasing_7, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_8.pickle', 'wb')
pickle.dump(nondecreasing_8, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_9.pickle', 'wb')
pickle.dump(nondecreasing_9, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_10.pickle', 'wb')
pickle.dump(nondecreasing_10, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_11.pickle', 'wb')
pickle.dump(nondecreasing_11, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_12.pickle', 'wb')
pickle.dump(nondecreasing_12, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_13.pickle', 'wb')
pickle.dump(nondecreasing_13, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_14.pickle', 'wb')
pickle.dump(nondecreasing_14, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_15.pickle', 'wb')
pickle.dump(nondecreasing_15, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_16.pickle', 'wb')
pickle.dump(nondecreasing_16, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_17.pickle', 'wb')
pickle.dump(nondecreasing_17, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_18.pickle', 'wb')
pickle.dump(nondecreasing_18, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_19.pickle', 'wb')
pickle.dump(nondecreasing_19, pickle_out)
pickle_out.close()

pickle_out = open('nd_random_integers_20.pickle', 'wb')
